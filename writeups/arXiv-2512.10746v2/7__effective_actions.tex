...
\begin{equation}
\sum_{m,n\ge1}\left(\frac{m}{n^3}\right)^{1/2}
...
% In the 4-graviton amplitude, the kinematic factor of 
% The $t_8t_8R^4$ term has a 10d interpretation, because the tensor $t_8$ arises from traces over gamma matrices of SO(8) \cite{Schwarz:1982jn}, the little group of SO(9, 1).
% Thus the kinematic structure of $t_8t_8 R^4$ is that of the 8d space transverse to a massless vector, which does not require the momenta to be present in all 10 dimensions: it may be evaluated on backgrounds with spectator dimensions.
...
\end{equation}
For 4-point amplitudes in 10d, we may evaluates contributions from loops of the infinite tower of massive KK-modes using Schwinger proper time
...
In other words, the tower of KK-modes on a torus acts as surrogates for the D(-1) background.
