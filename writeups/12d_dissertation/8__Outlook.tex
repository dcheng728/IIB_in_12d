...
In addition, the 3-form sector of the 8-derivative effective action admits a factorisation that is compatible with a 12d interpretation (see Footnote~\ref{footnote:3-form-factorisation}), and it would be interesting to explore this further.
...
A sharper understanding of the 12d uplifts of the type IIB branes can push this forward.
One would need to construct worldvolume actions for the 12d uplifts of the D3 brane, and the known relations between the 6d (2,0) theory and the 4d $\mathcal{N}=4$ SYM theory may provide a useful guide.
