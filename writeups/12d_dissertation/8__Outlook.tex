...
\begin{enumerate}
    ...
    \item Consistency with the higher-derivative corrections (Section~\ref{sec:effective-actions}) is only partial, and ultimately obstructed. At four points the 8-derivative effective action can be written in 12d-covariant form, but at five points a U(1)-preserving axio-dilaton term obstructs it.
\end{enumerate}
