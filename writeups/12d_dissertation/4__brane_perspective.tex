...
The 12d interpretations of the type IIB D7 and D(-1) backgrounds were first identified in \cite{Tseytlin:1996ne}. Here we derive them explicitly, alongside the corresponding type IIA constructions, and use them to read off how the type IIB \SLZ{} duality acts geometrically in 12d.
...
For more general (p, q) branes one would need to use the appropriate \SLZ{} section.
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.45\textwidth]{torusc.png}
