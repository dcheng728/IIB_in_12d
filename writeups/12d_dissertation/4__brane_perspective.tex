...
In the case of compactifying on a torus of signature (1,1), a factor of $i$ arises both in identifying the U(1) generator from $\Gamma_{11,12}$ and in defining the Euclidean compact scalar $C = i\mathcal C$, so that the 12d covariant derivative again reproduces the type IIB gravitino variation.
