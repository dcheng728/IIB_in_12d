...
The other $\frac{1}{2}$-BPS solution of the axio-dilaton action \eqref{IIB axio-dilaton action} is the D(-1) instanton, which has been recognized as a 12d pp-wave \cite{Tseytlin:1996ne}.
...
\end{equation}
Under a local supersymmetry transformation parameterized by a spinor $\epsilon$, one can write down a general ansatz for the Killing spinor equation of the gravitino from covariance alone
\begin{equation}
\delta\psi_M
= \left\{
\nabla_M + \sum_n \left[
