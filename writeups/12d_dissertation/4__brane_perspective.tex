...
\end{equation}
where $\vec{y}$ is a 3d Euclidean vector which, together with the compact coordinate $z$, forms a 4d space that is an $S_1$ fibration over $\mathbb{R}^3$.
...
A torus has topology $S^1 \times S^1$. We adopt coordinates $\vec{\sigma} \in \mathbb{R}^2$ by periodically identifying them as $(\sigma^1,\sigma^2)\sim (\sigma^1,\sigma^2) + 2\pi (m,n)$ for integers $m,n$.
...
We can equivalently describe coordinates on the torus with $\mathbb{C}$.
