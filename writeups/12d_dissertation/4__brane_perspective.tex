...
\end{equation}
with $j(\tau)$ the holomorphic modular invariant function, and $P_{N-1}(z)$ a degree $N-1$ polynomial, the roots of which are the locations of the $N-1$ D7 branes, the $N$-th D7 brane being at infinity where $P_N/P_{N-1}$ has a pole.
