...
String theory is a framework in theoretical physics that attempts to unify the two pillars of fundamental physics: quantum mechanics and general relativity.
It does so by replacing point-like particles with one-dimensional strings in the underlying mathematical description.
Despite receiving no experimental confirmations, it is an elegant framework with astonishing mathematical consistency.
String theory is known to be mathematically consistent only in 10 (for supersymmetric string theories) and 26 (for bosonic string theory) dimensions.

In 10 dimensions, there are five consistent superstring theories: type IIA, type IIB, heterotic SO(32), heterotic E8 x E8, and type I.
...
For instance, the type IIA and the heterotic E8 x E8 theories can be obtained from M-theory compactified on a circle and an interval, respectively.
The type IIB theory is believed to be the decompactifying (strong coupling) limit of M-theory on a torus, which provides a natural explanation for its conjectured SL(2, Z) duality.
However, this relation is somewhat unsatisfying, and it has long been conjectured that the type IIB theory may admit a more direct 12d interpretation.

The type IIB string theory is believed to have an exact, nonperturbative SL(2, Z) symmetry.
...
After the construction of the 11d supergravity \cite{Nahm:1977tg,Cremmer1978}, it was soon realized that SO(10, 2) Majorana-Weyl spinors may offer a natural setting for a 12d supersymmetric theory \cite{Castellani:1982ke,Blencowe:1988sk}.
