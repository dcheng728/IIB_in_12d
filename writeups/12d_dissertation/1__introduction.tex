...
Yet this explanation is unsatisfactory, as the SL(2, Z) duality of the type IIB theory is a fundamental feature in 10d, and thus one should not have to take a detour through 9d to understand it.
...
It is natural to ask whether an analogous relation holds on the type IIB side, between the $\mathrm{AdS}_5 \times S^5$ background and the $\mathcal{N}=4$ SYM theory, which carries its own SL(2, Z) duality acting on its complexified coupling.
