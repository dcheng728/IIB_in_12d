...
The two guiding questions that motivate this review---whether the type IIB theory has a higher-dimensional origin, and what the role and origin of its SL(2, Z) duality are---are pursued through the following concrete objectives:
\begin{enumerate}
    ...
    \item to test the 12d interpretation against the higher-derivative corrections that render SL(2, Z) exact, and to delineate its limitations (Section \ref{sec:effective-actions}).
\end{enumerate}
