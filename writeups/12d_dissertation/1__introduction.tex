...
This thesis is motivated by two guiding questions: whether the type IIB theory has a higher-dimensional origin, and what the role and origin of its \SLZ{} duality are.
...
This thesis is organised as follows. Section~\ref{sec:iib-puzzles} introduces the type IIB theory and its puzzles, and Section~\ref{sec:12d-supergravity-attempts} reviews, for completeness, earlier works relevant to the construction of a 10+2d supergravity. 
