...
This dissertation is motivated by two guiding questions: whether the type IIB theory has a higher-dimensional origin, and what the role and origin of its \SLZ{} duality are. 
...
This thesis is organised as follows. Section~\ref{sec:iib-puzzles} introduces the type IIB theory and its puzzles, and Section~\ref{sec:12d-supergravity-attempts} reviews, for completeness, earlier attempts at a 10+2d supergravity. The four objectives above are then taken up in turn in Sections~\ref{sec:axio-dilaton-12d}--\ref{sec:effective-actions}, with the analogous type IIA constructions presented throughout. We conclude in Section~\ref{sec:outlook} with a summary and open directions.