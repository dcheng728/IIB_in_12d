...
However, a 10+2d theory has two timelike directions, and a supersymmetric theory with two times faces fundamental obstructions.
...
\end{equation}
where $\Gamma_n$ are the antisymmetrised gamma-matrix structures and $Z_n$ the central charges (the 2-form and self-dual 6-form of \eqref{OSp algebra}). Because the RHS is symmetric and positive definite, we can diagonalise it.
