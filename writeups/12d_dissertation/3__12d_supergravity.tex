...
To see this, we split the 12d space as $11+1$, an 11d base $x^m$ together with a single extra coordinate $y$. Following \cite{Choi:2014vya,Choi:2015gia}, we package all dependence on the twelfth coordinate $y$ into a single scalar $r\equiv r(x,y)$, which also enters the metric:
\begin{equation}
