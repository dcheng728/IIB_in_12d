...
\end{equation}
Besides the 11d algebra, \eqref{OSp algebra} also reduces to the 10d type IIA and type IIB algebras \cite{Bergshoeff:2000qu,Bergshoeff:2000vg,Bergshoeff:2000vh}, so it sits above all three maximal supergravities. 
This unifying role made it a natural starting point for attempts to formulate a supersymmetric 10+2d theory of gravity \cite{Castellani:1982ke}, and for studying the objects such a theory would contain: 2+2d branes can propagate in (10, 2) spacetime \cite{Blencowe:1988sk}, and their BPS states \cite{Ueno:1999xa} and the fractions of supersymmetry they preserve \cite{Manvelyan:1998kx} have been classified. 
