...
\end{equation}
Besides the 11d algebra, \eqref{OSp algebra} also reduces to the 10d type IIA and type IIB algebras \cite{Bergshoeff:2000qu,Bergshoeff:2000vg,Bergshoeff:2000vh}, so it sits above all three maximal supergravities. This unifying role made it a natural starting point for attempts to formulate a supersymmetric 10+2d theory of gravity \cite{Castellani:1982ke}, and for studying the objects such a theory would contain: 2+2d branes can propagate in (10, 2) spacetime \cite{Blencowe:1988sk}, and their BPS states \cite{Ueno:1999xa} and the fractions of supersymmetry they preserve \cite{Manvelyan:1998kx} have been classified. At a purely algebraic level, these ideas extend to proposals for unifying the various dualities in 12 and 13 dimensions \cite{Bars:1996dz,Bars:1996us,Bars:1996ab,Bars:1996hr}, and even in 14 dimensions \cite{Rudychev:1997ui,Bars:1997ug}.
...
\label{Choi action}
\end{equation}
Here $\widehat{F}_5 = d\widehat{C}_4$ and $\widehat{F}_4 = d\widehat{C}_3$. 
...
\widehat{F}_5(x,y) \equiv r(x,y) F_4\wedge dy,
\end{equation}
\begin{equation}
...
Substituting these into \eqref{Choi action} and evaluating $\int d^{11}x dy \sqrt{-\widehat{g}} \widehat{R}$, the action reduces to
\begin{equation}
2\kappa_{12}^2 S =
