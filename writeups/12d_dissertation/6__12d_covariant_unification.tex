...
We orient the torus so that $dz_2\wedge dz_1$ is the positively-oriented volume element, i.e. $\int_{T_2}dz_1\wedge dz_2 = -Vol(T_2)$. This fixes the sign of the 12d Hodge dual $*_{12}$, and hence the signs in the self-duality relation \eqref{12d interpretation of 10d self-duality} and in the Chern--Simons term.
}
...
Although one often thinks of F1 and NS5, D1 and D5 as EM dual pairs, their form fields $H_3$ and $F_3$ configurations are not related by EM duality in 10d, and of course they have opposite dilaton profiles as well\footnote{The brane solutions are listed in \ref{sec:10d IIB branes}}.
...
The KK-Monopole uplift of D7-brane is not an exception because a 12d KK-monopole is localised on $S_1 \times \mathbb{R}^3$: there is indeed a compact circle in 12d.
