...
Let the 12d coordinates be parameterized by $(x^m,z_1,z_2)$, and let $\hat{g}_{ab}$ be the $2\times 2$ metric on the torus.\footnote{
...
Recently a 12d uplift of the various form fields has been proposed \cite{Cheng:2025efp}. Let us uplift the F1, D1, NS5, D5 branes to 12d.
...
\paragraph{Caveat: in what sense is this ``12d''?}
The uplifts are ``12d'' only in a limited sense.
Substituting the reduction ansätze of Section~\ref{sec:a-covariant-unification-in-12d} into the 12d repackaged action \eqref{12d action} returns the 10d type IIB action; varying it with respect to $g^{mn}$ and $\tau$, for instance, produces the 10d Einstein and axio-dilaton equations of motion.
They are not, however, solutions of unconstrained 12d gravity.
