...
In the previous section we have seen that the D(-1) and D7 solutions admit an uplift to 12d, and that their Killing spinor equations are consistent with a 12d Killing spinor equation, if there were to exist one, reduced on a torus.
...
We provide a catalog of the various brane solutions in the appendix [add appendix reference: Catalog of Branes].

Disregarding the fact that no 12d supergravity theory is known to exist, one can immediately identify the difficulties in finding 12d uplifts of such brane solutions.
...
In the following table we summarize the 10d massless on-shell degrees of freedom in type IIB as well as the number of degrees of freedom for the corresponding on-shell 12d field.
...
There are no 12d field configurations that can reduce to the type IIB fields.
But this may not be the end of the story, as the embedding of the 10d axio-dilaton sector into the 12d metric did not produce the 12d metric (two additional 10d 1-form potentials are needed) but there is still a 12d interpretation of the axio-dilaton sector that provides new perspectives to the D(-1) and D7 branes, as we had discussed previously.
