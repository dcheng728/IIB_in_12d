...
A genuine 12d electric 3-brane would therefore warp its three worldvolume directions \emph{uniformly} by $H^{-2/3}$.
The F1 uplift instead splits them, as shown in Table~\ref{tab:warp-comparison}.
\begin{table}[h]
\centering
\begin{tabular}{l|cc}
\hline
direction & genuine 12d 3-brane & F1 uplift\\
\hline
$t,x_1$ & $H^{-2/3}$ & $H^{-3/4}$\\
$z_1$ & $H^{-2/3}$ & $H^{-1/2}$\\
...
\end{tabular}
\caption{
Warp exponents of a genuine 12d electric 3-brane sourced by $\hat F_4$, compared with those of the F1 uplift.
