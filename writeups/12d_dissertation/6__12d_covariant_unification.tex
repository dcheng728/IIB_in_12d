...
Let us perform EM duality on the $\hat{F}_4$ configuration of F1.
\begin{equation}
(\hat{F}_8)_{m_1 m_2 ...m_7 z_2} = \varepsilon_{m_1 m_2 m_3 ... m_7 n}\partial_n H
\end{equation}
if we decompose $\hat{F}_8$ back to $\hat{F}_4$ in 12d, by $\hat{F}_8 = \varepsilon_4 \wedge \hat{F}_4$, this is indeed the $\hat{F}_4$ configuration of the D5 uplift. From there performing SL(2, Z) duality $z_1 \leftrightarrow z_2$ we reach the NS5 uplift.
