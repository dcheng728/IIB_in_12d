...
Already in the axio-dilaton sector the embedding into the 12d metric was only partial (the two off-diagonal Kaluza-Klein 1-forms were set to zero, so the full 12d metric was never reconstructed), yet it still furnished a 12d perspective on the D(-1) and D7 branes, as discussed in the previous section.
