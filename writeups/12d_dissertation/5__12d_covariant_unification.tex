...
This is a manifestation of the fact that the equation obtained in 12d by varying the volume of the torus is not imposed in 10d, where it's not a dynamical field.
We accordingly treat the uplifts as a 12d repackaging of the 10d backgrounds, rather than as genuine 12d solutions.

Although F1 and NS5, and D1 and D5, are often regarded as electromagnetic dual pairs, their $H_3$ and $F_3$ configurations are not related by electromagnetic duality alone in 10d: the two branes in each pair carry opposite dilaton profiles. 
Obtaining the NS5 from the F1, for instance, requires an accompanying \SLZ{} transformation to invert the dilaton, as also occurs on the D3 worldvolume \cite{Tseytlin:1996it}.

We now treat the F1, D1, NS5, and D5 branes in turn.
