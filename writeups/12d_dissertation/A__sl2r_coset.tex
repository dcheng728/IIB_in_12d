...
To construct the kinetic term for the scalars, one builds the sl(2, $\mathbb{R}$)-valued Maurer-Cartan 1-form $\mathcal{V}^{-1}\partial_m\mathcal{V}$, which decomposes into the non-compact and compact elements of the sl(2,$\mathbb{R}$) algebra: $\mathcal{V}^{-1}\partial_m\mathcal{V} = P_m + Q_m$, where $P_m$ projects onto the non-compact generators and $Q_m$ is the SO(2) connection.
