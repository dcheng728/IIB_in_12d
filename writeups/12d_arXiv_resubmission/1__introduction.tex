...
\]
Despite receiving no direct experimental validation, string theory remains an elegant framework of astonishing internal consistency.
...
\end{enumerate}
We return to each of these in the concluding section.
